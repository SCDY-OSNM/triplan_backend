...
@RequestMapping("api/v1/plans/plandetails")
public class PlanDetailController {
    ...
    public ResponseEntity<ApiResponse<PlanDetailResponseDto>> createPlanDetail(@RequestHeader ("X-Authenticated-User") Long userId, @RequestBody PlanDetailRequestDto planDetailRequestDto){
        PlanDetailResponseDto planDetailResponseDto = planDetailService.createPlanDetail(planDetailRequestDto);
        return ResponseEntity.ok(ApiResponse.success("플랜 디테일 생성 완료", planDetailResponseDto));
    }

    @GetMapping("/{planDetailId}")
    public ResponseEntity<ApiResponse<PlanDetailResponseDto>> readPlanDetail(@RequestHeader ("X-Authenticated-User") Long userId, @PathVariable("planDetailId") Long planDetailId){
    ...
    public ResponseEntity<ApiResponse<List<PlanDetailResponseDto>>> readPlanDetailsList(@RequestHeader ("X-Authenticated-User") Long userId, @PathVariable("planId") Long planId){
    ...
    public ResponseEntity<ApiResponse<PlanDetailResponseDto>> updatePlanDetailOrder(@RequestHeader ("X-Authenticated-User") Long userId, @PathVariable("planDetailId") Long planDetailId, @RequestBody Integer planDetailTimeLine, Integer planDetailDay){
    ...
    public ResponseEntity<ApiResponse<PlanDetailResponseDto>> updatePlanDetailContent(@RequestHeader ("X-Authenticated-User") Long userId, @PathVariable("planDetailId") Long planDetailId, @RequestBody PlanDetailRequestDto planDetailRequestDto){
    ...
    public ResponseEntity<ApiResponse<PlanDetailResponseDto>> deletePlanDetail(@RequestHeader ("X-Authenticated-User") Long userId, @PathVariable("planDetailId") Long planDetailId){
