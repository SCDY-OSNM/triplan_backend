...
public class UserService {
    ...
    public String login(UserRequestDto userRequestDto) {
        ...
        String accessToken = jwtUtils.createToken(user.getUserId(),user.getUserRole().toString());
        String refreshToken = jwtUtils.createRefreshToken(user.getUserId(),user.getUserRole().toString());
